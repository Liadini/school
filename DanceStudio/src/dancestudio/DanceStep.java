...
public class DanceStep {
	private int initialTurnL, forwardDistanceL, sidewaysDistanceL, finalTurnL, initialTurnR, forwardDistanceR,
			sidewaysDistanceR, finalTurnR;

	public DanceStep(int t1L, int dxL, int dyL, int t2L, int t1R, int dxR, int dyR, int t2R) {
		initialTurnL = t1L;
	...
	public String toString() {
		return "[" + initialTurnL + ", " + forwardDistanceL + ", " + sidewaysDistanceL + ", " + finalTurnL
